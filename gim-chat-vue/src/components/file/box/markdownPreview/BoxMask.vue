		...
		<div class="markdown-preview-wrapper" v-show="visible" @click.self="closeMarkdownPreview">
			...
			<div class="tip-wrapper" v-if="visible">
				...
				<div class="tool-wrapper">
					...
					<i class="item el-icon-close" title="关闭预览" @click="closeMarkdownPreview"></i>
				</div>
			</div>
			<!-- mavon-editor 组件，配置项说明文档 https://www.npmjs.com/package/mavon-editor -->
			<mavonEditor ref="mavonEditor" v-model="markdownText" :toolbars="toolbars" :editable="editable"
				:toolbarsFlag="toolbarsFlag" :externalLink="externalLink" :subfield="screenWidth > 768 ? true : false"
				defaultOpen="preview" v-loading="markdownLoading" @save="handleModifyFileContent"></mavonEditor>
		</div>
	</transition>
</template>
