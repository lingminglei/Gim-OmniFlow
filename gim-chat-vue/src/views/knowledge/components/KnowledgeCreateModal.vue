  ...
  >
    <div class="knowledge-modal__content">
      <header class="knowledge-modal__header">
        ...
        <div>
          <span class="knowledge-modal__kicker">CREATE KNOWLEDGE BASE</span>
          <h3>创建知识库</h3>
          <p>录入知识库名称与描述，创建后即可继续上传文档并整理内容。</p>
        </div>
      </header>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-position="top" class="knowledge-form">
        ...
        <el-form-item label="知识库描述" prop="description">
          <el-input
            ...
            maxlength="500"
            show-word-limit
            placeholder="请简要描述该知识库的用途、内容范围和适用场景"
          />
        </el-form-item>
      </el-form>
